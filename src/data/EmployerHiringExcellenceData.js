const hiring_excellence_data = [
  {
    name: "empower-hiring-teams",
    MetaData: {
      metaTitle: "Empower Hiring Teams with Connect EC",
      metaDescription:
        "Ignite recruiter motivation through autonomy, recognition, and mastery, transforming daily tasks into measurable achievements.",
    },
    HeroData: {
      ...
      tabs: [
        {
          ...
          activeImage: "/employer/Self-Determination-Theory-white.svg",
          inactiveImage: "/employer/Self-Determination-Theory.svg",
          heading:
        ...
        },
        {
          ...
          activeImage: "/employer/Self-Efficiency-Theory-white.svg",
          inactiveImage: "/employer/Self-Efficiency-Theory.svg",
    ...
    BlockStepsSectionData: {
      ...
      easyBannerData: {
        title: "Recruiter Motivation Made",
        content:
        "In hiring, motivated minds win the war — not just the sharpest swords. EC makes motivation easy by turning passion into consistent, measurable action. Through daily nudges, gamified milestones, progress tracking, and recognition features, EC keeps recruiters engaged and focused. Motivated recruiters don’t just meet targets — they exceed them."
      },
    },

    CTASectionData: {
      title: "Ignite Recruiter Motivation!",
      description:"Transform pressure into purpose and performance into passion. Build teams that stay driven, resilient, and unstoppable — all powered by behavioral science.",
  ...
  {
    name: "explore-hiring-trends",
    MetaData: {
      metaTitle: "Explore Hiring Trends & Insights with Connect EC",
      metaDescription:
        "Stay ahead with Connect EC’s hiring trends and insights. Uncover the true drivers of interview and offer declines through deep behavioral analysis.",
    },
    HeroData: {
      ...
      tabs: [
        {
          ...
          activeImage: "/employer/Attribution-Theory-white.svg",
          inactiveImage: "/employer/Attribution-Theory.svg",
        ...
        {
          tab: "Prospect Theory",
          activeImage: "/employer/Prospect-Theory-white.svg",
          inactiveImage: "/employer/Prospect-Theory.svg",
...

        {
          ...
          activeImage: "/employer/Social-Exchange-Theory-white.svg",
          inactiveImage: "/employer/Social-Exchange-Theory.svg",
    ...
    BlockStepsSectionData: {
      ...
      steps: [
        {
          ...
          letter: "E",
          icon: "/employer/Decode-Declines.svg",
          description:
        ...
        },
        {
          ...
          letter: "A",
          icon: "/employer/Discover-Trends.svg",
          description:
        ...
        },
        {
          ...
          letter: "S",
          icon: "/employer/Drive-Decisions.svg",
          description:
        ...
        },
        {
          ...
          letter: "Y",
          icon: "/employer/Deliver-Results.svg",
          description:
      ...
      easyBannerData: {
        ...
        content:
        "Understanding candidate sentiment shouldn’t be guesswork. EC’s Hiring Explorer makes it easy by uncovering real emotions and concerns behind every decision. By mapping behavior drivers, Explorer turns sentiment into strategy, enabling organizations to refine hiring approaches, improve candidate experience, and drive better outcomes."
      },
    },

    CTASectionData: {
      title: "Decode Candidate Declines!",
      description:"Transform your hiring strategy with behavior-driven intelligence that uncovers the real drivers behind candidate choices and delivers measurable results — all powered by behavioral science.",
      sub_title: "Start for Free. Hire Stress-Free!",
      button_text: "Unlock EC Today",
      button_link: "#",
    },
  },
  {
    name: "engage-talent",
    MetaData: {
      metaTitle: "Engage Top Talent Effectively with Connect EC",
      metaDescription:
        "Nurture stronger commitment, minimize drop-offs, and secure top talent with structured follow-ups, real-time insights, and personalized engagement.",
    },
    HeroData: {
      ...
      tabs: [
        {
          ...
          activeImage: "/employer/Peak-End-Rule-white.svg",
          inactiveImage: "/employer/Peak-End-Rule.svg",
          heading:
        ...
        },
        {
          ...
          activeImage: "/employer/Commitment-Consistent-Principle-white.svg",
          inactiveImage: "/employer/Commitment-Consistent-Principle.svg",
    ...
    BlockStepsSectionData: {
      ...
      steps: [
        ...
        },
        {
          title: "Share Stories",
          letter: "A",
          icon: "/employer/Share-Stories.svg",
          description:
        ...
        },
        {
          ...
          letter: "S",
          icon: "/employer/Solidify-Trust.svg",
          description:
        ...
        },
        {
          title: "Secure Talent",
          letter: "Y",
          icon: "/employer/Secure-Talent.svg",
          description:
      ...
      easyBannerData: {
        ...
        content:
        "Post-offer engagement shouldn’t be a struggle. Vault makes it easy by turning routine steps into meaningful touchpoints. From instantly sharing offer letters to showcasing curated culture images and scaling leadership messages, Vault transforms static processes into dynamic engagement moments. With Vault, hiring success isn’t just a goal — it’s a guarantee."
      },
    },

    CTASectionData: {
      title: "Turn Offers into Commitments!",
      description:"Transform your post-offer engagement into a personalized journey that builds excitement, nurtures confidence, and strengthens long-term relationships — all powered by behavioral science.",
      sub_title: "Start for Free. Hire Stress-Free!",
      button_text: "Unlock EC Today",
      button_link: "#",
    },
  ...
  {
    name: "exceed-hiring-targets",
    MetaData: {
      metaTitle: "Exceed Recruitment Goals with Connect EC",
      metaDescription:
        "Streamline workflows, optimize candidate experience, and drive consistent, measurable success with customized recommendations and interactive dashboards.",
    },
    HeroData: {
      ...
      tabs: [
        {
          ...
          activeImage: "/employer/Plan-Do-Check-Act-white.svg",
          inactiveImage: "/employer/Plan-Do-Check-Act.svg",
          heading:
        ...
        },
        {
          ...
          activeImage: "/employer/Theory-of-Constraints-white.svg",
          inactiveImage: "/employer/Theory-of-Constraints.svg",
    ...
    BlockStepsSectionData: {
      ...
      steps: [
        ...
        },
        {
          ...
          letter: "A",
          icon: "/employer/Monitor-Progress.svg",
          description:
        ...
        },
        {
          ...
          letter: "S",
          icon: "/employer/Measure-Success.svg",
          description:
        ...
        },
        {
          title: "Meet Targets",
          letter: "Y",
          icon: "/employer/Meet-Targets.svg",
          description:
      ...
      easyBannerData: {
        ...
        content:
        "Achieving recruitment targets shouldn’t be uncertain. EC makes it easy with a Recruitment Success Engine that turns targets into achievable outcomes. By optimizing talent acquisition and enabling data-driven recommendations, organizations can consistently exceed expectations. With C-Suite, targets aren’t chased - they’re conquered."
      },
    },

    CTASectionData: {
      title: "Exceed Every Hiring Target!",
      description:"Transform goals into growth with data-driven insights that map objectives, monitor progress, measure success, and meet targets — all powered by behavioral science.",
      sub_title: "Start for Free. Hire Stress-Free!",
      button_text: "Unlock EC Today",
      button_link: "#",
    },
